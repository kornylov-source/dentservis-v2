...
export default function BlogTable({ items }: { items: Item[] }) {
      ...
      <div className="overflow-x-auto rounded-xl border border-slate-200 bg-white">
        <table className="w-full text-sm">
          <thead className="bg-slate-50 text-left text-slate-500">
            <tr>
              <th className="px-4 py-3 font-medium">Зображення</th>
            ...
            {items.map((it) => {
              ...
              return (
                <tr key={it.id}>
                  ...
                  <td className="px-4 py-3 text-slate-600">{it.date}</td>
                  <td className="px-4 py-3">
                    <span
