...
export const doctors: Doctor[] = [
  ...
  },
  {
    ...
    bio: [
      "Провідний ендодонт клініки з 21-річним досвідом. Спеціалізується на порятунку зубів зі складними запаленнями та анатомією — рятує те, що в інших клініках рекомендують видаляти.",
      "Майстерно знаходить ультратонкі та приховані канали, які «не бачить» рентген. Безпечно вилучає уламки інструментів та переліковує запущені канали. Щорічно вдосконалює навички в терапевтичній стоматології та ендодонтії.",
    ],
    expertise:
    ...
    quote:
      "Моя мета — зберегти ваш власний зуб у 100% випадків, коли це фізично можливо. Ставлюся до пацієнта так, як хотіла б, щоб віднеслись до мене.",
  ...
  },
  {
    ...
    bio: [
      "Стоматолог-терапевт із 20-річним досвідом. Провідний спеціаліст у терапевтичному лікуванні — понад 20 років успішної практики та тисячі вдячних пацієнтів.",
      "Спеціалізується на роботі з пацієнтами, які відчувають страх або тривогу перед лікуванням. Лікар, яка вміє вислухати, заспокоїти та знайти індивідуальний підхід до кожного. Їй довіряють здоров'я своїх родин цілі покоління пацієнтів.",
