...
Відповідь: "Вартість імплантації залежить від клінічної ситуації і обговорюється на консультації хірурга (вона безкоштовна). Ми працюємо з імплантами MegaGen (Корея). Записатись: [Контакти](${clinic.contactsUrl}) або ${clinic.phone}."
