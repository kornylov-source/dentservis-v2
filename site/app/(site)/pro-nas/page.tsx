...
export const metadata: Metadata = {
  title: "Про нас — Дентсервіс | Дніпро",
  description:
    "Дентсервіс — медичний центр у Дніпрі з 2003 року. Цифровий протокол лікування: 3D-сканування, конусно-променева томографія, цифрові відбитки. 6 лікарів, 30+ років практики медичного директора, доказова медицина.",
