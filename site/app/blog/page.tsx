...
export const metadata: Metadata = {
  title: "Блог Дент-Сервіс — статті про сучасну стоматологію | Дніпро",
  description:
    "Корисні статті від лікарів Дент-Сервіс: імплантація, естетика, лікування ясен, профілактика. Експертний контент без академічної мови.",
  alternates: {
    canonical: "https://dent-servis.com.ua/blog",
  },
  openGraph: {
    title: "Блог Дент-Сервіс — статті про сучасну стоматологію",
    description:
