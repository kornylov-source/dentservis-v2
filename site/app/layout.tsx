...
export const metadata: Metadata = {
  title: "Дент-Сервіс — медичний центр у Дніпрі",
  description:
    "Сучасний медичний центр з цифровим протоколом лікування. Імплантація, ортопедія, пародонтологія, естетична стоматологія. 20+ років досвіду в Дніпрі.",
  icons: {
